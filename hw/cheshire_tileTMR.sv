...
(
  ...
  output floo_req_t floo_req_south_oA,
  output floo_req_t floo_req_south_oB,
  output floo_req_t floo_req_south_oC,
  input floo_rsp_t floo_rsp_south_iA,
  input floo_rsp_t floo_rsp_south_iB,
  input floo_rsp_t floo_rsp_south_iC,
  output floo_wide_t floo_wide_south_oA,
  output floo_wide_t floo_wide_south_oB,
  output floo_wide_t floo_wide_south_oC,
  input floo_req_t floo_req_south_iA,
  input floo_req_t floo_req_south_iB,
  input floo_req_t floo_req_south_iC,
  output floo_rsp_t floo_rsp_south_oA,
  output floo_rsp_t floo_rsp_south_oB,
  output floo_rsp_t floo_rsp_south_oC,
  input floo_wide_t floo_wide_south_iA,
  input floo_wide_t floo_wide_south_iB,
  input floo_wide_t floo_wide_south_iC,
  ...
  assign floo_req_south_oA           = router_floo_req_outA[South];
  assign floo_req_south_oB           = router_floo_req_outB[South];
  assign floo_req_south_oC           = router_floo_req_outC[South];
  ...
  assign router_floo_req_inA[North]  = '0;  // No North port in this tile
  assign router_floo_req_inB[North]  = '0;  // No North port in this tile
  assign router_floo_req_inC[North]  = '0;  // No
  ...
  assign router_floo_req_inA[South]  = floo_req_south_iA;
  assign router_floo_req_inB[South]  = floo_req_south_iB;
  assign router_floo_req_inC[South]  = floo_req_south_iC;
  ...
  assign floo_rsp_south_oA           = router_floo_rsp_outA[South];
  assign floo_rsp_south_oB           = router_floo_rsp_outB[South];
  assign floo_rsp_south_oC           = router_floo_rsp_outC[South];
  ...
  assign router_floo_rsp_inA[North]  = '0;  // No North port in this tile
  assign router_floo_rsp_inB[North]  = '0;  // No North port in this tile
  assign router_floo_rsp_inC[North]  = '0;  // No North port in this tile
  ...
  assign router_floo_rsp_inA[South]  = floo_rsp_south_iA;
  assign router_floo_rsp_inB[South]  = floo_rsp_south_iB;
  assign router_floo_rsp_inC[South]  = floo_rsp_south_iC;
  ...
  assign floo_wide_south_oA          = router_floo_wide_outA[South];
  assign floo_wide_south_oB          = router_floo_wide_outB[South];
  assign floo_wide_south_oC          = router_floo_wide_outC[South];
  ...
  assign router_floo_wide_inA[North] = '0;  // No North port in this tile
  assign router_floo_wide_inB[North] = '0;  // No North port in this tile
  assign router_floo_wide_inC[North] = '0;  // No North port in this tile
  ...
  assign router_floo_wide_inA[South] = floo_wide_south_iA;
  assign router_floo_wide_inB[South] = floo_wide_south_iB;
  assign router_floo_wide_inC[South] = floo_wide_south_iC;
